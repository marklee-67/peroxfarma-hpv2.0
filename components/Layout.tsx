...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col font-sans">
      ...
      {/* Footer */}
      <footer className="w-full bg-gray-100 text-text-secondary pt-16 pb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            <div className="col-span-1 md:col-span-1 flex flex-col gap-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-bold text-text-primary">Peroxfarmakorea</h3>
              </div>
             ...
             <div className="col-span-1 md:col-span-1">
              <h4 className="font-bold text-text-primary mb-4">고객지원</h4>
            ...
            <div className="col-span-1 md:col-span-1">
              <h4 className="font-bold text-text-primary mb-4">소셜 미디어</h4>
              <div className="flex gap-4">
                <a href="#" className="h-10 w-10 flex items-center justify-center rounded-full bg-white text-gray-400 hover:text-primary hover:shadow-md transition-all">
