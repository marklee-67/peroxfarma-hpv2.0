...
본 약관은 Peroxfarma(이하 "회사")가 제공하는 서비스의 이용조건 및 절차, 이용자와 회사의 권리, 의무, 책임사항을 규정함을 목적으로 합니다.
...
Peroxfarma는 다음의 목적을 위해 개인정보를 수집 및 이용합니다.
- 서비스 제공 및 계약의 이행
- 회원 관리 및 본인 확인
- 고객 상담 및 불만 처리
- 마케팅 및 광고 활용
...
const defaultAboutConfig: AboutConfig = {
  introText: `개인 맞춤형 건강기능식품의 미래를 선도하는 Peroxfarmakorea 입니다.\n인류의 건강 증진이라는 단 하나의 목표를 가지고 설립되었습니다.`,
