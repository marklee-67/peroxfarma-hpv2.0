    ...
    <div className="w-full">
      ...
      <div className="mx-auto max-w-[1200px] px-4 py-20">
        ...
        <section className="mb-20">
          <h2 className="text-3xl font-bold text-center mb-12 text-text-primary">신뢰할 수 있는 생산 원칙</h2>
        ...
        <section className="mb-20 bg-gray-50 rounded-2xl p-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-text-primary">제조 공정</h2>
        ...
        {/* Gallery */}
        <section className="mb-20">
          <h2 className="text-3xl font-bold text-center mb-4 text-text-primary">시설 둘러보기</h2>
          <p className="text-center text-text-secondary mb-10">우리의 최첨단 시설을 이미지로 만나보세요.</p>
        ...
        <section>
          <div className="bg-primary/5 rounded-2xl p-12 text-center">
            <h3 className="text-2xl font-bold mb-4 text-text-primary">믿을 수 있는 제품, 지금 만나보세요</h3>
            <p className="text-text-secondary mb-8">과학적인 데이터 기반의 개인 맞춤 영양제를 구독하고 건강을 챙겨보세요.</p>
            <Link to="/products" className="inline-flex h-12 px-8 items-center justify-center rounded-lg bg-primary text-white font-bold hover:bg-primary/90 transition-colors">
              구독 서비스 알아보기
            </Link>
          </div>
        </section>
