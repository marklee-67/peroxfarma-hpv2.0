...
const Home: React.FC = () => {
  return (
    <div className="w-full">
        ...
        <div className="mx-auto max-w-[1200px] px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="flex flex-col items-center gap-4 rounded-xl border border-gray-100 bg-white p-8 text-center shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 relative">
              {[
                ...
                <div key={idx} className="flex flex-col items-center text-center gap-4 relative bg-white md:bg-transparent">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full border-2 border-primary bg-white text-lg font-bold text-primary z-10">
                    {item.step}
                  </div>
                  <span className="material-symbols-outlined text-5xl text-primary/80 my-2">{item.icon}</span>
                  <div>
      ...
      <section className="w-full py-20 bg-background-light">
        <div className="mx-auto max-w-[1200px] px-4">
          <div className="flex flex-col items-center gap-12 rounded-2xl bg-primary/5 p-12 text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 w-full max-w-4xl">
               {[
                 ...
                 <div key={idx} className="flex flex-col items-center gap-3">
                   <img src={cert.src} alt={cert.label} className="h-20 w-20 rounded-full bg-white object-contain p-2 shadow-sm" />
